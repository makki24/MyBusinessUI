...
describe('LoginScreen', () => {
    ...
    it('calls loginOrSignUp on successful response', async () => {
        ...
        const mockResponse = { type: 'success', authentication: { accessToken: 'mockToken' } };
        const mockPromptAsync = jest.fn();
        const useAuthRequestMock = jest.spyOn(Google, 'useAuthRequest');
        useAuthRequestMock.mockReturnValue([null, mockResponse as AuthSessionResult,  mockPromptAsync]);
        ...
        await act(async () => {
            ...
            await waitFor(() => {
                expect(fetch).toHaveBeenCalledWith(`http://192.168.150.103:9191/loginOrSignUp`, {
                    method: 'GET',
                    headers: {
