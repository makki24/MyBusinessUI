...
const AdminScreen = ({ navigation }) => {
    ...
    const [currentImageIndex, setCurrentImageIndex] = useState(Array(images.length).fill(0));
    ...
    return (
        <ScrollView contentContainerStyle={homeScreenStyles.container}>
            ...
            <View style={homeScreenStyles.cardsContainer}>
                <Card style={homeScreenStyles.card} onPress={() => navigation.navigate('RolesStack', { screen: 'Roles' })}>
                ...
                <Card style={homeScreenStyles.card} onPress={() => navigation.navigate('ExpenseTypeStack', { screen: 'ExpenseTypes' })}>
                ...
                <Card style={homeScreenStyles.card} onPress={() => navigation.navigate('TagsStack', { screen: 'Tags' })}>
                ...
                <Card style={homeScreenStyles.card} onPress={() => navigation.navigate('WorkStack', { screen: 'WorkType' })}>
