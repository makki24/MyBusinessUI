...
const SearchAndFilter: React.FC<SearchAndFilterProps> = ({handleSearch, searchQuery, user, sender, receiver, onApply}) => {
    ...
    return (
        <View style={commonStyles.row}>
            ...
            >
                <FilterScreen user={user} sender={sender} receiver={receiver} onApply={onApplyFilter} defaultFilter={currentFilter} onClose={() => bottomSheetModalRef.current.close()} />
            </BottomSheetModal>
        </View>
    )
}
