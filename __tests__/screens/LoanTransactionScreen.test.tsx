...
jest.mock("../../services/ContributionService.ts", () => ({
    getLoanClearTransactions: jest.fn(() => [{ id: 1, amount: 100, date: new Date('2023-12-10')}]),
    ...
    it('renders correctly', async () => {
        ...
        await waitFor(() => {
            act(() => {
                ...
                const deleteModalText = getByText('Are you sure you want to delete this loan transaction?');
